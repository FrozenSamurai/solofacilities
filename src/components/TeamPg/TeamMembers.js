...
const TeamMembers = ({ imagePath, name, role, description }) => {
  return (
    <div
      data-aos="flip-left"
      className="flex items-center justify-center w-full md:w-2/5 shadow-xl border-black h-fit rounded-full border-2 my-3 hover:border-gray-300 p-2 hover:bg-slate-100 backdrop-blur-lg hover:backdrop-blur-0"
      style={{
